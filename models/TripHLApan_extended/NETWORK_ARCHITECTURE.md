# TripHLApan Network Architecture

## Overview
TripHLApan implements a **Triple Coding Matrix** approach with 3 parallel neural network paths that process peptide and HLA allele sequences using different encodings, then fuses the learned representations.
...
## Model Performance (TripHLApan_extended)
