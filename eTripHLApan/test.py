#!/usr/bin/env python3
"""
eTripHLApan Testing Script
Evaluates the enhanced TripHLApan model on the test set
"""
...
print("="*70)
print("eTripHLApan Model Testing")
print("="*70)
...
# Compute metrics
print("\n" + "="*70)
print("TEST RESULTS - eTripHLApan MODEL (EPOCH 2)")
print("="*70)
...
# Save results
results_file = os.path.join(RESULTS_DIR, 'test_metrics.txt')
with open(results_file, 'w') as f:
    f.write("="*70 + "\n")
    f.write("eTripHLApan Model - Test Results\n")
    f.write("="*70 + "\n\n")
