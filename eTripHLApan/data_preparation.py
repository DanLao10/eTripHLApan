#!/usr/bin/env python3
"""
Data preparation script for converting MHC_Binding_Dataset_Final.csv to TripHLApan format.

Input format (CSV):
    HLA.Class.I.Allele, Epitope...Peptide, Assay.Qualitative.Measurement, Expression, ...

Output format (for TripHLApan training):
...
def prepare_data(csv_path, output_dir='../for_prediction/', train_ratio=0.7, val_ratio=0.15, test_ratio=0.15):
    """
    Convert MHC_Binding_Dataset_Final.csv to TripHLApan training format.
...
if __name__ == '__main__':
    ...
    csv_path = '/home/jimmy/gdrive/Kids/DanielLao/ScienceFair/2025/Tcell-therapy/MHC_Binding_Dataset_Final.csv'
    ...
    print(f"3. For training: modify TripHLApan.py to use training_data.txt")
