#!/usr/bin/env python3
"""
Extended Training Script for TripHLApan
Based on original train.py but with more epochs (300) and early stopping
"""
...
print("="*70)
print("TripHLApan Extended Training Script")
print("="*70)
...
MODEL_SAVE_PATH = '../../models/TripHLApan_extended/'
